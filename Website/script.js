    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            weatherBoxes.forEach(function (box, index) {
                ...
                box.innerHTML += '<br>' + temperatureCelsius.toFixed(1) + '°C' + '<br>';
                ...
                if (forecast.windSpeed) {
                    box.innerHTML += '<br><br><span style="font-size: 20px;">Wind Speed: ' + forecast.windSpeed + '</span>';
                }
                if (forecast.windDirection) {
                    box.innerHTML += '<br><span style="font-size: 18px;">Wind Direction: ' + forecast.windDirection + '</span>';
                }
            });
        })
